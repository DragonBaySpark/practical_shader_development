...
void ofApp::setup()
{
    ...
    // 加载名为parrot.png的图像文件
    parrotImage.load("parrot.png");
    checkerImage.load("checker.jpg");
...
void ofApp::draw()
{
    // 开始使用着色器，准备进行渲染
    shader.begin();
    shader.setUniformTexture("checkerTex", checkerImage, 0);
    shader.setUniformTexture("parrotTex", parrotImage, 1);
